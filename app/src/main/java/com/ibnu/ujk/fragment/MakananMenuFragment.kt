...
class MakananMenuFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_makanan_menu, container, false)
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        list = arrayListOf()
        rv_list = view.findViewById(R.id.rv_menu_makanan)

        adapter = MenuFragmentAdapter(list)

        list.addAll(DataMenu.itemListMakanan)
